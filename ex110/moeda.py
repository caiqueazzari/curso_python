...
def resumo(preco=0, aumento=0, reducao=0):
    ...
    print('-' * 30)
    print(f'Preço analisado: {monetário(preco):>13}')
    print(f'Dobro do preço: {dobro(preco, True):>13}')
    print(f'Metade do preço: {metade(preco, True):>13}')
    print(f'{aumento}% de aumento: {aumentar(preco, aumento, True):>13}')
    print(f'{reducao}% de desconto: {diminuir(preco, reducao, True):>13}')
    print('-' * 30)